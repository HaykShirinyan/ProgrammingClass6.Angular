...
- Create Angular project with ng: `ng new programmingclass6.angular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`programmingclass6.angular.client.esproj`).
